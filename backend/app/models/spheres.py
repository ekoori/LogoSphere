...
class Sphere:
    def __init__(self, sphere_id, name, description, value_graph, location, image, admin1, participants, alliances, projects, values):
    ...
    def create(cls, data, admin1):
        ...
        query = """
        INSERT INTO spheres (sphere_id, name, description, value_graph, location, image, admin1, participants, alliances, projects, values, created_at)
        VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)
        """
        cassandra_session.execute(query, (sphere_id, name, description, value_graph, location, image, admin1, participants, alliances, projects, values, datetime.utcnow()))

        return cls(sphere_id, name, description, value_graph, location, image, admin1, participants, alliances, projects, values)
