...
# docker cp /home/dev1/LogoSphere/database/export_dummy_data.sh cassandra:/scripts/export_dummy_data.sh
...
tables=$(cqlsh --cqlversion=3.4.7 -e "USE logosphere; DESCRIBE TABLES;")
for table in $tables; do
  echo "Exporting $table to CSV..."
  cqlsh --cqlversion=3.4.7 -e "USE logosphere; COPY $table TO '$EXPORT_DIR/$table.csv' WITH HEADER = TRUE;"
done
